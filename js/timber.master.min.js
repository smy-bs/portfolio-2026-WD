      ...
      e(t)
        ...
        .each(function () {
          ...
          if (
            ...
            "img" == e(this).get(0).nodeName.toLowerCase() &&
      ...
      function s(t, i) {
        ...
        for (s in i)
          ((n = i[s]),
            t[s] !== n &&
              (a[s] ||
                ((e.fx.step[s] || !isNaN(parseFloat(n))) && (o[s] = n))));
        return o;
      }
      ...
      contactForm: function () {
        $(_).submit(function (a) {
          ...
          var b = $(this),
            ...
            l = [];
          b.find("input:not([type=submit]),select,textarea").each(
            function (a, b) {
              var c = $(b),
                d = c.attr("name");
